...
# qr_url = "https://passport2.chaoxing.com" + bs.find(id="quickCode")["src"]
# re_qr = requests.get(qr_url)
# with open("1.jpg","wb") as f:
#     f.write(re_qr.content)
# os.system("1.jpg")
...
if __name__ == "__main__":
    try:
        ...
        个人资料路径 = "/home/uodrad/.config/google-chrome/Default"  #Chrome访问chrome://version/找到个人资料路径进行更改
        chrome_opt.add_argument("%U --user-data-dir="+个人资料路径)
        drive = webdriver.Chrome('/usr/local/bin/chromedriver',options=chrome_opt)
